    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remarks', models.CharField(max_length=255, null=True, blank=True, verbose_name='備考')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID')),  # 自動生成されるIDを明示的に指定
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mail', models.EmailField(max_length=255, null=True, blank=True, verbose_name='メールアドレス')),
            ],
            options={
